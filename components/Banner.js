  ...
  return (
    <div className = 'w-screen space-y-5 text-white lg:flex sm:ml-5'>
      <div className = 'lg:space-y-8 xl:ml-10'>
        <h1 className = 'font-extrabold text-2xl w-full pr-16 pl-3 pt-2 sm:text-3xl sm:w-[25rem] md:text-6xl md:w-[47rem] md:pl-7 xl:mt-32 2xl:mt-52 xl:text-7xl xl:w-[50rem] 2xl:text-8xl 2xl:w-[70rem] open:translate-x-10'>
