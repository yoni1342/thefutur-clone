  ...
  return (
    <div className = 'w-screen space-y-5 text-white lg:flex sm:ml-5'>
      <div className = 'lg:space-y-8 xl:ml-10'>
        ...
        <p className = 'font-extralight text-sm pl-3 pr-28 md:text-lg md:pl-7 xl:text-2xl lg:text-xl xl:w-[50rem] 2xl:w-[60rem]'>On a mission to help one billion people make a living doing what they love (without losing their soul). We’re like a private art school - minus the crippling debt.</p>
